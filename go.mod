module github.com/xiaomeng79/go-example
...
require (
	...
	github.com/fwhezfwhez/jwt v0.0.0-20180928085247-84be5a75dfe7 // indirect
	...
	github.com/micro/micro v0.14.0
	...
	github.com/xiaomeng79/go-log v2.0.1+incompatible
	github.com/xiaomeng79/go-utils v0.0.0-20181017074258-e4925b865baa
	go.uber.org/atomic v1.3.2 // indirect
	go.uber.org/multierr v1.1.0 // indirect
	go.uber.org/ratelimit v0.0.0-20180316092928-c15da0234277 // indirect
	go.uber.org/zap v1.9.1 // indirect
	golang.org/x/crypto v1.1.1
	golang.org/x/net v1.1.1
	golang.org/x/sys v1.1.1
	gopkg.in/natefinch/lumberjack.v2 v2.0.0 // indirect
	gopkg.in/yaml.v2 v2.2.1 // indirect
)

replace golang.org/x/sys v1.1.1 => github.com/golang/sys v0.0.0-20181031143558-9b800f95dbbc

replace golang.org/x/crypto v1.1.1 => github.com/golang/crypto v0.0.0-20181030102418-4d3f4d9ffa16

replace golang.org/x/net v1.1.1 => github.com/golang/net v0.0.0-20181029044818-c44066c5c816
